...
//   await prisma.audienceTFAnswer.deleteMany()
//   await prisma.audienceQuestionPrediction.deleteMany()
//   await prisma.audienceRoundPrediction.deleteMany()
//   await prisma.audienceMember.deleteMany()
//   await prisma.teamAnswer.deleteMany()
...
//     data: {
//       name: 'Youth Sunday Bible Challenge',
...
//             color: '#EF4444',
//             pin: '7432',
//             members: { create: [{ name: 'John' }, { name: 'Ada' }, { name: 'Mike' }] },
//           },
//           {
//             name: 'Team Zion',
//             color: '#3B82F6',
//             pin: '1923',
//             members: { create: [{ name: 'Samuel' }] },
//           },
//           {
//             name: 'Team Grace',
//             color: '#22C55E',
//             pin: '5841',
//             members: { create: [{ name: 'Ruth' }, { name: 'Esther' }] },
//           },
//         ],
//       },
//       rounds: {
...
//   console.log(`Seeded quiz: ${quiz.name} (${quiz.id})`)
// }
...
async function main(): Promise<void> {
  try {
    // 🧹 CLEAN
    await prisma.audienceInteraction.deleteMany()
    await prisma.audienceTFAnswer.deleteMany()
    await prisma.audienceQuestionPrediction.deleteMany()
    await prisma.audienceRoundPrediction.deleteMany()
    await prisma.audienceMember.deleteMany()
      ...
      data: {
        ...
        rounds: {
          create: [
            ...
            //         order: 8,
            //         type: 'open',
            //         text: 'What is the first commandment about?',
            //         correctAnswer: 'Worship only God',
            //         aliases: JSON.stringify(['No other gods', 'Only one God']),
            //         points: 10,
            //         difficulty: 'easy',
            //       },
            //       {
    ...
    const quizWithTeams = quiz as any
    ...
    await prisma.session.create({
      data: {
        ...
        sessionTeams: {
          create: quizWithTeams.teams.map((t: any) => ({
            teamId: t.id,
          })),
        },
      },
    ...
    console.log(`🔑 Team Join Codes — see Teams tab in admin dashboard`)
  } catch (e: any) {
